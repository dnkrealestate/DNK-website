...
//       <h1 className="text-[#fff] text-center mt-3 mb-0">Floor Plan</h1>
...
//           }}
//         >
//           <div className="bg-sky-700 w-full h-full absolute opacity-40"></div>
//         <div
...
//             width={120}
//             height={120}
//             className="w-[50%] md:w-[40%] object-contain hidden md:block z-10"
//           />
//         </div>
