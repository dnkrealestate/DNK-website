...
export const ADContactForm = ({ onFormSubmit, promotionData }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div style={{ "--themeColor": promotionData.themeColor }} className="flex flex-col justify-between mx-0 md:mx-2 mt-3 md:mt-0">
        <div>
          <input
        ...
        <div>
          <button
            type="submit"
            disabled={loading}
            className="bg-black hover:bg-[var(--themeColor)] text-white w-full p-2.5 mt-6 rounded flex justify-center items-center"
          >
          ...
          <div className="flex items-center justify-center mt-4">
            ...
            >
              ...
              >
                <FaWhatsapp className="text-[#6B9B2D] text-lg ml-2 group-hover:text-[#6B9B2D]" />
                <p className="ml-1 text-[#6B9B2D] group-hover:text-[#6B9B2D] mb-0">
                  WhatsApp
                </p>
              </a>
            </div>
