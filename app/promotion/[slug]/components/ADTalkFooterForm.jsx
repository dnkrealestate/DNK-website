...
const ADTalkFooterForm = ({ onFormSubmit, promotionData }) => {
  ...
  const addLeadtobitrix = async (name, email, phone, city) => {
    ...
    const leadData = {
      fields: {
        TITLE: `Promotion ${promotionData?.projectName} Website Lead`,
        NAME: name,
      ...
      <div className="flex flex-col justify-between mx-0 md:mx-[10px] mt-3 md:mt-0">
        ...
        <div >
          <button
            ...
            className="bg-white hover:bg-[var(--themeColor)] text-black hover:text-white w-full p-[10px] mt-[25px] rounded flex justify-center"
            disabled={loading}
          >
            {loading ? (
          ...
          <div className="flex items-center justify-center mt-4">
            ...
            >
              <a
                href="https://wa.me/+971543049309?text=Hey, Please share details of Damac Islands New Community."
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center ml-2 group"
              >
                <FaWhatsapp   className="text-[#6B9B2D] text-xl group-hover:text-[#6B9B2D]" />
                <p className="ml-1 mb-0 text-[#6B9B2D] group-hover:text-[#6B9B2D]">
                  WhatsApp
                </p>
              </a>
            </div>
