...
import Assist from "@/public/assets/pojects/dynamicWeb/icon01.webp";
import Consultation from "@/public/assets/pojects/dynamicWeb/icon02.webp";
import Estimation from "@/public/assets/pojects/dynamicWeb/icon03.webp";
import Shedule from "@/public/assets/pojects/dynamicWeb/icon04.webp";
import ADTalkFooterForm from "./ADTalkFooterForm";
import { WWURL } from "@/url/axios";

const TalkFooterNad = ({promotionData}) => {
      ...
      >
        <div className="container max-w-[1240px] py-5 px-4 md:py-9 talkSection">
          <div className="grid md:grid-cols-2 relative pt-8">
            ...
            <ADTalkFooterForm promotionData={promotionData} />
          </div>
        </div>
      </div>
