...
export const BannerPayment = ({ promotionData }) => {
   ...
   <div className="relative w-full h-[300px] md:h-[500px] overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-center h-full">
        <div className="text-center text-white px-4">
          <h1 className="text-3xl md:text-5xl font-bold mb-2">{promotionData.paymentPlanBannerTitle}</h1>
           ...
           style={{ "--themeColor": promotionData.themeColor }}>
            ...
            /
            <Link
              href="/promotion/sobha-skyparks/paymentPlan"
              className={`text-[#fff] hover:text-[var(--themeColor)] pr-1`}
            >
              Payment Plan
            </Link>
