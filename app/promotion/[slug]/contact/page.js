...
export async function generateMetadata({ params }) {
  ...
  const title = `${promotionData.seoTitleContact? promotionData.seoTitleContact : promotionData.seoTitle}`;
  const description = `${promotionData?.projectdescriptionContact ? promotionData.projectdescriptionContact : promotionData.projectdescription}`;
  const keywords = [
    promotionData.projectName,
    promotionData.projectkeywordContact ? promotionData.projectkeywordContact : promotionData.projectkeyword,
    promotionData.developer.replace(/-/g, ' '),
  ];

  const canonicalUrl = `https://www.dnkre.com/promotion/${promotionData.promoUrl.replace(/\s+/g, "-").toLowerCase()}/contact`;
