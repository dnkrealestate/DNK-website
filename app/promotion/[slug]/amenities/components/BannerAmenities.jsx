...
export const BannerAmenities = ({ promotionData }) => {
  const imageUrl = promotionData?.subBanner ? `${WWURL}${promotionData.subBanner}` : null;
  const videoUrl = promotionData?.bannerVideo ? `${WWURL}${promotionData.bannerVideo}` : null;
    ...
    <div className="relative w-full h-[300px] md:h-[500px] overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-center h-full">
        <div className="text-center text-white px-4">
          <h1 className="text-3xl md:text-5xl font-bold mb-2">{promotionData.amenitiesBannerTitle}</h1>
           ...
           style={{ "--themeColor": promotionData.themeColor }}>
            ...
            /
            <Link
              href="/promotion/sobha-skyparks/amenities"
              className={`text-[#fff] hover:text-[var(--themeColor)] pr-1`}
            >
              Amenities
            </Link>
