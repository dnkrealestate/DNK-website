...
export default function DetailAmenities({promotionData}) {
     ...
     <div className="w-full bg-[#040406] flex items-center justify-center">
      <div className="container max-w-[1240px] py-5  px-4  md:py-9 relative">
        <h1 className="text-[#fff] m-auto w-fit">{promotionData?.amenitiesSectionTitle}</h1>
              ...
              <p dangerouslySetInnerHTML={{ __html: promotionData?.amenitiesSectionSubTitle }} className="w-full mt-4 text-left m-auto ">
              </p>
