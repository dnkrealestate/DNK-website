...
export async function generateMetadata({ params }) {
  ...
  const title = `${promotionData.seoTitleMasterPlan? promotionData.seoTitleMasterPlan : promotionData.seoTitle}`;
  const description = `${promotionData?.projectdescriptionMasterPlan ? promotionData.projectdescriptionMasterPlan : promotionData.projectdescription}`;
  const keywords = [
    promotionData.projectName,
    promotionData.projectkeywordMasterPlan ? promotionData.projectkeywordMasterPlan : promotionData.projectkeyword,
    promotionData.developer.replace(/-/g, ' '),
  ];

  const canonicalUrl = `https://www.dnkre.com/promotion/${promotionData.promoUrl.replace(/\s+/g, "-").toLowerCase()}/masterPlan`;
