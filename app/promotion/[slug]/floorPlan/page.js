...
export async function generateMetadata({ params }) {
  ...
  const title = `${promotionData.seoTitleFloorPlans? promotionData.seoTitleFloorPlans : promotionData.seoTitle}`;
  const description = `${promotionData?.projectdescriptionFloorPlans ? promotionData.projectdescriptionFloorPlans : promotionData.projectdescription}`;
  const keywords = [
    promotionData.projectName,
    promotionData.projectkeywordFloorPlans ? promotionData.projectkeywordFloorPlans : promotionData.projectkeyword,
    promotionData.developer.replace(/-/g, ' '),
  ];

  const canonicalUrl = `https://www.dnkre.com/promotion/${promotionData.promoUrl.replace(/\s+/g, "-").toLowerCase()}/floorPlan`;
