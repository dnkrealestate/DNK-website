...
const FooterNad = () => {
  const [phoneNumber, setPhoneNumber] = useState("");
    ...
    const pageTitle = `Immediate Website Call Back Lead from Damac Islands New Community}`;
      ...
      >
        <div className="footerSection container max-w-[1240px]  px-3 py-8">
          <div className="w-[90px] md:w-[200px] m-auto ">
            <Image
              src="https://api.dnkre.com/e42c7012-8478-4b82-9735-b2b3c05123e8damac.svg"
              alt="logo"
              width={200}
              height={100}
        ...
        {showCallForm && (
          <div className="absolute bottom-16 right-0 bg-white text-black p-4 rounded-lg shadow-lg w-64 animate-slideIn">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                className="w-full bg-[#0D84C8] text-[#fff] py-2 rounded hover:bg-[#0D84C8] transition"
                disabled={loading}
              >
                {loading ? (
