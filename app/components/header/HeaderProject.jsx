...
export function HeaderProject({ projectId }) {
  ...
  const logoSwitch = projectId.developerlogo? `${WWURL}${projectId.developerlogo}` : dnkLogo
  return (
    <>
      <header>
        <div className="header flex container items-center justify-between h-15 max-w-[1240px] mx-auto px-4 py-2">
          <div className="left-block flex items-center justify-center gap-4 md:gap-0">
            ...
            <Link href="/">
              <div className="relative w-[120px] h-[45px] flex items-center justify-start">
                <Image
                  src={logoSwitch}
                  alt={`${
                ...
                <li
                  onClick={() => {
                    track("Call Button Click Header", {
                      track: `page: ${pathname},
                  button: Call Button Header Project,
                  action: Call to Dann,
                  phone: +971555769195`,
                    });
                  }}
